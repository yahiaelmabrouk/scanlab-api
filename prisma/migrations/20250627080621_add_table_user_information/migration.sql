-- AlterTable
ALTER TABLE "Users" ADD COLUMN     "region" TEXT DEFAULT 'us_east';
...
-- AddForeignKey
ALTER TABLE "UserInformations" ADD CONSTRAINT "UserInformations_userId_fkey" FOREIGN KEY ("userId") REFERENCES "Users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
