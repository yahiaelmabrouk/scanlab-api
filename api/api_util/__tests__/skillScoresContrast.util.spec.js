const subject = require('../skillScoresContrast.util')
...
describe('SkillsScoresContrastUtil', () => {
  describe('#calculateContrastParameters', () => {
    it('should return skillScore of 100 when all components are 100', () => {
      expect(subject.calculateContrastParameters(perfectScore).skillScore).toBeCloseTo(100)
    })

    it('should return skillScore of 50 when all components are 50', () => {
      expect(subject.calculateContrastParameters(midScore).skillScore).toBeCloseTo(50)
    })
  })
