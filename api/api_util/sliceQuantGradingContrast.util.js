...
const SliceQuantGradingContrastUtil = {
  calculateScores(answer, selectedAnswer, modifiers, rubricOverride = undefined, attributes = null) {
    ...
    scoreDetails.combinedScore = _.round(
      scoreDetails.parameterScore.combinedScore * 0.6 + scoreDetails.slicePrescriptionScore.combinedScore * 0.4,
      2
    )
...
module.exports = SliceQuantGradingContrastUtil
